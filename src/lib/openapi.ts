  ...
  paths: {
        ...
        parameters: [
          {
            ...
            in: "query",
            schema: { type: "string" },
            description: "Search name/bio/genres",
          },
          {
            name: "genre",
            in: "query",
    ...
    "/djs/{id}": {
      get: {
        ...
        description:
          "Full profile: summary, mixes, articles, socials, collabs, labels, similar DJs, upcoming and past gigs.",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        responses: {
          "200": {
            description: "DJ dossier",
            content: { "application/json": { schema: { $ref: "#/components/schemas/DjDetail" } } },
          },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/EventListResponse" } },
            },
          },
        },
      },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/VenueListResponse" } },
            },
          },
        },
      },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/DjListResponse" } },
            },
          },
        },
      },
    ...
    "/dataset": {
      get: {
        ...
        description:
          "Complete snapshot: DJs, events, venues, links, articles, mixes. For reuse in other products.",
        responses: {
          "200": {
            description: "Full dataset",
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/DatasetExport" } },
            },
          },
        },
      },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/DatasetMeta" } },
            },
          },
        },
      },
