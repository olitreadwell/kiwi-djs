...
const GENRE_PALETTE: Array<{ pill: string; tint: string }> = [
  { pill: "bg-red-700 text-white", tint: "border-red-500/60 bg-red-500/10 hover:bg-red-500/20" },
  {
    pill: "bg-orange-700 text-white",
    tint: "border-orange-500/60 bg-orange-500/10 hover:bg-orange-500/20",
  },
  {
    pill: "bg-amber-700 text-white",
    tint: "border-amber-500/60 bg-amber-500/10 hover:bg-amber-500/20",
  },
  {
    pill: "bg-yellow-700 text-white",
    tint: "border-yellow-500/60 bg-yellow-500/10 hover:bg-yellow-500/20",
  },
  {
    pill: "bg-lime-700 text-white",
    tint: "border-lime-500/60 bg-lime-500/10 hover:bg-lime-500/20",
  },
  {
    pill: "bg-green-700 text-white",
    tint: "border-green-500/60 bg-green-500/10 hover:bg-green-500/20",
  },
  {
    pill: "bg-emerald-700 text-white",
    tint: "border-emerald-500/60 bg-emerald-500/10 hover:bg-emerald-500/20",
  },
  {
    pill: "bg-teal-700 text-white",
    tint: "border-teal-500/60 bg-teal-500/10 hover:bg-teal-500/20",
  },
  {
    pill: "bg-cyan-700 text-white",
    tint: "border-cyan-500/60 bg-cyan-500/10 hover:bg-cyan-500/20",
  },
  { pill: "bg-sky-700 text-white", tint: "border-sky-500/60 bg-sky-500/10 hover:bg-sky-500/20" },
  {
    pill: "bg-blue-700 text-white",
    tint: "border-blue-500/60 bg-blue-500/10 hover:bg-blue-500/20",
  },
  {
    pill: "bg-indigo-700 text-white",
    tint: "border-indigo-500/60 bg-indigo-500/10 hover:bg-indigo-500/20",
  },
  {
    pill: "bg-violet-700 text-white",
    tint: "border-violet-500/60 bg-violet-500/10 hover:bg-violet-500/20",
  },
  {
    pill: "bg-purple-700 text-white",
    tint: "border-purple-500/60 bg-purple-500/10 hover:bg-purple-500/20",
  },
  {
    pill: "bg-fuchsia-700 text-white",
    tint: "border-fuchsia-500/60 bg-fuchsia-500/10 hover:bg-fuchsia-500/20",
  },
  {
    pill: "bg-pink-700 text-white",
    tint: "border-pink-500/60 bg-pink-500/10 hover:bg-pink-500/20",
  },
  {
    pill: "bg-rose-700 text-white",
    tint: "border-rose-500/60 bg-rose-500/10 hover:bg-rose-500/20",
  },
  {
    pill: "bg-stone-700 text-white",
    tint: "border-stone-500/60 bg-stone-500/10 hover:bg-stone-500/20",
  },
  { pill: "bg-red-800 text-white", tint: "border-red-400/60 bg-red-400/10 hover:bg-red-400/20" },
  {
    pill: "bg-orange-800 text-white",
    tint: "border-orange-400/60 bg-orange-400/10 hover:bg-orange-400/20",
  },
  {
    pill: "bg-amber-800 text-white",
    tint: "border-amber-400/60 bg-amber-400/10 hover:bg-amber-400/20",
  },
  {
    pill: "bg-yellow-800 text-white",
    tint: "border-yellow-400/60 bg-yellow-400/10 hover:bg-yellow-400/20",
  },
  {
    pill: "bg-lime-800 text-white",
    tint: "border-lime-400/60 bg-lime-400/10 hover:bg-lime-400/20",
  },
  {
    pill: "bg-green-800 text-white",
    tint: "border-green-400/60 bg-green-400/10 hover:bg-green-400/20",
  },
  {
    pill: "bg-emerald-800 text-white",
    tint: "border-emerald-400/60 bg-emerald-400/10 hover:bg-emerald-400/20",
  },
  {
    pill: "bg-teal-800 text-white",
    tint: "border-teal-400/60 bg-teal-400/10 hover:bg-teal-400/20",
  },
  {
    pill: "bg-cyan-800 text-white",
    tint: "border-cyan-400/60 bg-cyan-400/10 hover:bg-cyan-400/20",
  },
  { pill: "bg-sky-800 text-white", tint: "border-sky-400/60 bg-sky-400/10 hover:bg-sky-400/20" },
  {
    pill: "bg-blue-800 text-white",
    tint: "border-blue-400/60 bg-blue-400/10 hover:bg-blue-400/20",
  },
  {
    pill: "bg-indigo-800 text-white",
    tint: "border-indigo-400/60 bg-indigo-400/10 hover:bg-indigo-400/20",
  },
  {
    pill: "bg-violet-800 text-white",
    tint: "border-violet-400/60 bg-violet-400/10 hover:bg-violet-400/20",
  },
  {
    pill: "bg-purple-800 text-white",
    tint: "border-purple-400/60 bg-purple-400/10 hover:bg-purple-400/20",
  },
  {
    pill: "bg-fuchsia-800 text-white",
    tint: "border-fuchsia-400/60 bg-fuchsia-400/10 hover:bg-fuchsia-400/20",
  },
  {
    pill: "bg-pink-800 text-white",
    tint: "border-pink-400/60 bg-pink-400/10 hover:bg-pink-400/20",
  },
  {
    pill: "bg-rose-800 text-white",
    tint: "border-rose-400/60 bg-rose-400/10 hover:bg-rose-400/20",
  },
  {
    pill: "bg-stone-800 text-white",
    tint: "border-stone-400/60 bg-stone-400/10 hover:bg-stone-400/20",
  },
];
