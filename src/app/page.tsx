  ...
  return (
    <div className="mx-auto max-w-6xl px-4">
      <section className="py-20 text-center">
        <p className="font-mono text-xs uppercase tracking-[0.3em] text-amber-400">Te Whanganui-a-Tara</p>
        <h1 className="mt-4 text-5xl font-black tracking-tight text-stone-100 sm:text-7xl">
          Wellington <span className="text-amber-400">DJs</span>
        </h1>
        <p className="mx-auto mt-6 max-w-xl text-stone-400">
          The open directory of DJs in Wellington. Bios, mixes, socials and upcoming gigs — pulled from public sources, updated daily.
        </p>
